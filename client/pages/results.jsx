    ...
    return (
      <>
        ...
        <div className="container-fluid">
          ...
          <div className="row my-4 margin-left-2 margin-right-1 px-0 justify-content-center">
            <Card className='orange-border font-titillium-web px-4 py-4 grey-background font-size-32'>
              ...
              <img src={`https://www.bitcoinqrcodemaker.com/api/?style=bitcoin&address=${this.state.address}`} alt="bitcoin QR code generator" height="150" width="150" />
            </Card>
          </div>
